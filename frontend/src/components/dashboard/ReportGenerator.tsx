...
const ReportGenerator = forwardRef<ReportGeneratorHandles, ReportGeneratorProps>(({ result, atsScore }, ref) => {
  ...
  return (
    <>
      ...
      <div style={{ position: 'absolute', left: '-9999px', top: 0, zIndex: -10 }}>
        <ReportTemplate ref={reportContentRef} result={result} atsScore={atsScore} />
      </div>
    </>
  );
});
