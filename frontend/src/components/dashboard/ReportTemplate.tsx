...
const ReportTemplate = React.forwardRef<HTMLDivElement, ReportTemplateProps>(({ result, atsScore }, ref) => {
    ...
    <div ref={ref} className="bg-white p-10 text-gray-800" style={{ width: '8.5in' }}>
        ...
        <div className="grid grid-cols-3 gap-8 mb-8">
            ...
            <div className="col-span-1 space-y-6">
                ...
                {atsScore !== undefined && (
                  <div className="border border-gray-200 rounded-lg p-4 text-center bg-blue-50">
                    <h2 className="text-xl font-bold mb-2 text-indigo-700">ATS Score</h2>
                    <p className={`text-6xl font-bold ${getScoreColor(atsScore)}`}>{atsScore}%</p>
                    <p className="text-sm text-gray-600 mt-2">Applicant Tracking System Score</p>
                  </div>
                )}
            </div>
             {/* Right Column */}
